...
## Introduction
In this tutorial, we show how to use scDesign3 to simulate data with batch effects and how to remove the batch effects.

## Read in the reference data
The raw data is from the `SeuratData`. The data is called `pbmcsca` in the package; it is PBMC Systematic Comparative Analysis dataset from the Broad Institute.
...
## Visulization
We first create three `SingleCellExperiment` object using three count matrix generated above.
```{r, message=FALSE}
