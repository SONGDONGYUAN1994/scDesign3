---
title: "Simulate dataset with multiple lineages"
author: 
  - name: Dongyuan Song
    affiliation:
...
## Simulation
Then, we can use this multiple lineages dataset to generate new data.
```{r, message=FALSE}
set.seed(123)
