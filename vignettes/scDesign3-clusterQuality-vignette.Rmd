...
For demonstration purpose, we use the `Zhengmix4eq` dataset in the package with top 100 highly varaible genes and the corresponding k-means clustering results with k = $2 ,\cdots, 10$.
```{r, message=FALSE}
