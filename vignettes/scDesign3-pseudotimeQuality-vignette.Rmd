---
title: "Evaluate pseudotime qualities using scDesign3"
author: 
  - name: Dongyuan Song
    affiliation:
...
## Introduction
In this tutorial, we will first use the R package `dyngen` to generate a dataset with ground truth \"pseudotime\". Then, we will perturb the ground truth pseudotime to worsen its quality and use scDesign3's BIC to examine different pseudotime qualities. 
