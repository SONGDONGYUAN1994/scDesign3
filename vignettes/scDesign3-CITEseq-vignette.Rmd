...
```{r, message=FALSE, warning=FALSE, results='hide'}
example_sce <- readRDS((url("https://www.dropbox.com/sh/0tptrft7hsstpi3/AAA2ly7fk9Ge98YB3FbiMtR9a/CITE_sce.rds?raw=1")))
print(example_sce)
```
...
```
Then, we obtained the PCA and UMAP for both the inputted reference data and the synthetic data. These embeddings will be used for the visualization below.
```{r, message=FALSE, warning=FALSE, results='hide'}
